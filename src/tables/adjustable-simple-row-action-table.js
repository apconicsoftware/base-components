...
export default class AdjustableSimpleRowActionTable extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Table {...tableOptions} style={{ tableLayout: 'auto' }}>
...
AdjustableSimpleRowActionTable.propTypes = {
